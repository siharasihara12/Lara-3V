...
module.exports = {
SESSION_ID: process.env.SESSION_ID || "6QYF2T4T#sVYhGr3MdTgaQXkpnRFqnLfTc6BrXe6QMbrzIb3fXm4", // Add your session id
PREFIX: process.env.PREFIX || "*",
MODE: process.env.MODE || "public",  //public | private | inbox | group
OWNER_NUMBER: process.env.OWNER_NUMBER || "94760419336",
